...
public class CDatabaseConnection implements Serializable {
    ...
    private static final long serialVersionUID = 8182843769500555498L;
    
    //static final String DB_URL = "jdbc:mysql://localhost/test";
    
    //static final String USER = "root";
    //static final String PASS = "123885";
...
public Boolean makeConnectionTodatabase (CDatabaseConnectionConfig databaseConnectionConfig, CExtendedLogger localLogger){
